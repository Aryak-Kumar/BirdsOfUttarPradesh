...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" >
  <head> 
    <title>Update Bird Data Base|Birds of Uttar Pradesh</title>
    <meta charset="utf-8">
...
<script>
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <font style="font-size: 100px; color: #D8D8D8"class="mb-3 bread">Bird Data Base</font>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span>  <span>Bird Data Base> </span></p>
                  <div class="mouse">
    ...
    <center><section class="ftco-section contact-section">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-12 mb-4">
            <h2 class="h3" id="con">Add to Data Base</h2>
          </div>
          <div class="w-100"></div>
        ...
        <div class="row block-9 ">
          <div class="col-lg-12 order-md-last d-flex">
            <form action='upload.php'id="contact" method='POST' enctype="multipart/form-data" class="bg-light p-4 p-md-5 contact-form">
                <div class="form-group" >
                <input style="text-align: center;" type="text" class="form-control" required="required"name="name" placeholder="Bird Name">
              </div><br>
              <div class="form-group" >
              ...
              <div class="form-group" >
                ...
                <select name="loc" class="form-control" required="required" >
                  ...
                  <option value="2">City/Village/Farm</option>
                  <option value="3">Desert</option>
                  <option value="4">Grassland</option>
                  <option value="5">Lakes/Rivers/Ponds</option>
                  <option value="6">Marsh/Swamp</option>
                  <option value="7">Mountain</option>
                  <option value="8">Woodland/Forest</option>
                </select>
              </div><br>
              ...
              <div class="form-group" >
                ...
                <select name="size" class="form-control" required="required" >
                  <option value="">select</option>
                  <option value="1">Large (16 - 32 inches)</option>
                  <option value="2">Medium (9 - 16 inches)</option>
                  <option value="3">Small (5 - 9 inches)</option>
                  <option value="4">Very Large (32 - 72 inches)</option>
                  <option value="5">Very Small (3 - 5 inches)</option></select> 
                </select>
              </div><br>
                                 
              <div class="form-group" >
                <label for="beak">Beak:</label>
                <select name="beak" class="form-control" required="required" >
                  <option value="">select</option>
                  <option value="1">All-purpose</option>
                  <option value="2">Chisel</option>
                  <option value="3">Cone</option>
                  <option value="4">Hooked</option>
                  <option value="5">Needle</option>
                  <option value="6">Probing</option>
                  <option value="7">Spear</option>
                  <option value="8">Special</option>
                  <option value="9">Strainer</option>
                  <option value="10">Tweezer</option>
                </select>
              </div><br>
            
              <div class="form-group" >
                <label for="colour">Colour:</label>
                <select name="colour" class="form-control" required="required" >
                  <option value="">select</option>
                  <option value="1">Black</option>
                  <option value="2">Blue</option>
                  <option value="3">Brown</option>
                  <option value="4">Cream/Buff</option>
                  <option value="5">Green/Olive</option>
                  <option value="6">Grey</option>
                  <option value="7">Orange</option>
                  <option value="8">Pink/Lilac</option>
                  <option value="9">Purple/Violet</option>
                  <option value="10">Red</option>
                  <option value="11">Rufous/Rust</option>
                  <option value="12">White</option>
                  <option value="13">Yellow</option>
                </select>
              </div><br>
              <div class="form-group" >
                <input style="text-align: center; height: 20" type="text" class="form-control" required="required" name="Description" placeholder="Description">
              </div>
              <div class="form-group" >
                <input style="text-align: center;" type="text" class="form-control" required="required"name="link" placeholder="Link">
              </div>
              <div class="form-group">
