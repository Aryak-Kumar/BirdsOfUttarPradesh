...
<html lang="en">
  <head>
    <title>Authors|Birds of Uttar Pradesh</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <font style="font-size: 100px; color: #D8D8D8"class="mb-3 bread">Authors</font>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span>  <span>Authors </span></p>
                  <div class="mouse">
